...
// import { componentBasePath, getPaths, templatesDir } from "../../src/utils/paths.js";
...
//     fs.mkdirSync(dest, { recursive: true }); // creates the folder
...
//       console.log("our new config path below")
//       const { componentPath: uiRoot } = getPaths(); // get fresh path
//       console.log("Component base path:", uiRoot);

//       console.log("our new config path above")
...
//           // });
//           copyRecursive(srcDir, destDir); // ← use recursive copy here
...
export default function registerAddCommand(program) {
  program
    ...
    .description("Add one or more Vueon UI components")
    .action(async (components) => {
      const { componentPath: uiRoot } = getPaths(); // dynamic current path
