<template>
    <div>
      ...
      <div
        ref="contentRef"
        :class="[
          'fixed inset-x-0 bottom-0 z-50 mt-24 flex flex-col bg-white rounded-t-xl border shadow-xl select-none transform transition-transform duration-300 ease-in-out',
      ...
      >
        <!-- Drag Handle -->
        <div class="mx-auto mt-4 h-2 w-24 rounded-full bg-gray-300 cursor-grab"></div>
        <slot />
      </div>
    </div>
  </template>
