...
import { MenubarContent } from 'reka-ui'
</script>

<template>
  <MenubarContent
    v-bind="$attrs"
    class="z-50 min-w-[180px] overflow-hidden rounded-md border border-border/50 bg-popover p-1 text-popover-foreground shadow-md 
